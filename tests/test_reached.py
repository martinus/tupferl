...
its CLI as `python -m tupferl` and drives a real `git` throughout, so the same
blind spot applies here for the same reason. On the woswoar run this module was
